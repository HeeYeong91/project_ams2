...
public class AMSFrame extends Frame {
	...
	public void searchAccountNum() {
		...
		Account account = AMS.repository.searchAccount(searchNum);
		mainTA.setText("");
		printHeader();
		if (account != null) {
			mainTA.append(account.toString());
	...
	public void serachAccountOwner() {
		...
		printHeader();
		List<Account> accounts = AMS.repository.searchAccountByOwner(searchOwner);
		if (accounts != null) {
	...
	public void deleteAccount() {
		...
		result = AMS.repository.removeAccount(accountNum);
		if (result == true) {
